...
Some of the configs are located in separate repositories and added here as 
...
with a bash-script, but the easiest way will be to use GNU Stow utility, which 
can be found in your distro's repository.
